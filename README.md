<h1 text-align="center">Abdullah-Framework-Template</h1>

## Introduction

Abdullah-Framework-Template - This project is based on Microsoft Playwright, which enables reliable end-to-end testing, Web testing.
